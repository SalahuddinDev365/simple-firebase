 ...
 * 3. got to web settings for firebase app and register the app
 * 4. npm install firebase
 * 5. get firebase config and add the config in your project. do not share your config.
 * 6. enable sign in method that you want to use: Build > Authentication > get 
 * Started > Click on Google > Enable > set the email address > save
